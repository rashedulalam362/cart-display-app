...
function updateCart(){
    ...
    cart.forEach((item)=>{
      ...
      <button class="btn btn-danger bg-danger" onclick="removeCartItem(${item.id})" >Remove button</button>
...
function renderSubTotal() {
  ...
  if (cart.length === 0) {
    subtotalEl.innerHTML = 'Subtotal (0 0): $0.00';
    return;
  }
  ...
  subtotalEl.innerHTML = `Subtotal (${totalItems} 0): $${totalPrice.toFixed(2)}`;
}
